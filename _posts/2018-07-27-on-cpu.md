...
stored value.  When a clock pulse arrives the counter performs one of three
...
<p align="center"> <img src="/assets/one_cpu/lidr2.gif"> </p>
<p align="center">
...
Note that "program" is stored in a ROM as well.
